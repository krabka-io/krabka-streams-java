...
Runs on every pull request and on pushes to `main`. Matrix over Java 17 and 21, both
running `./gradlew build`. This is the gate for compilation, unit tests, and Javadoc.
